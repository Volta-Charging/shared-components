...
import { MarkerContainer, Container } from './styled'
class SiteMarker extends Component {
  ...
  render() {
    const { text, onClick, issues, positionAbsolute } = this.props
    ...
    return (
      <Container markerWidth={width} markerHeight={height}>
        <NotificationBadge issues={issues} positionAbsolute={positionAbsolute}/>
